...
import { Menu, X, Sparkles, Code, Zap, User, Mail } from 'lucide-react';
    ...
    <motion.nav
      ...
      style={{
        background: pastHero 
          ...
          : 'linear-gradient(135deg, rgba(0, 0, 0, 0.7) 0%, rgba(15, 23, 42, 0.8) 50%, rgba(0, 0, 0, 0.7) 100%)',
        backdropFilter: 'blur(20px) saturate(180%)',
        boxShadow: pastHero 
          ? '0 25px 50px -12px rgba(6, 182, 212, 0.25), inset 0 1px 0 rgba(6, 182, 212, 0.1)'
          : '0 25px 50px -12px rgba(59, 130, 246, 0.25), inset 0 1px 0 rgba(59, 130, 246, 0.1)',
      }}
    >
      ...
      <motion.div
        ...
        animate={{
          background: pastHero
            ? [
                'linear-gradient(0deg, transparent, rgba(6, 182, 212, 0.4), transparent)',
                ...
                'linear-gradient(360deg, transparent, rgba(6, 182, 212, 0.4), transparent)',
              ]
            : [
          ...
          >
            ...
            <motion.div 
              ...
              style={{
                ...
                boxShadow: pastHero
                  ? '0 0 30px rgba(6, 182, 212, 0.5), inset 0 0 30px rgba(255, 255, 255, 0.1)'
                  : '0 0 30px rgba(59, 130, 246, 0.5), inset 0 0 30px rgba(255, 255, 255, 0.1)',
              }}
            >
